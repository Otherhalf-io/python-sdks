...
class DataTrackInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["name", b"name", "sid", b"sid", "uses_e2ee", b"uses_e2ee"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["name", b"name", "sid", b"sid", "uses_e2ee", b"uses_e2ee"]) -> None: ...
...
class DataTrackFrame(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["payload", b"payload", "user_timestamp", b"user_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["payload", b"payload", "user_timestamp", b"user_timestamp"]) -> None: ...
...
class PublishDataTrackCallback(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["async_id", b"async_id", "error", b"error", "result", b"result", "track", b"track"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["async_id", b"async_id", "error", b"error", "result", b"result", "track", b"track"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["result", b"result"]) -> typing_extensions.Literal["track", "error"] | None: ...
...
class LocalDataTrackTryPushRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["frame", b"frame", "track_handle", b"track_handle"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["frame", b"frame", "track_handle", b"track_handle"]) -> None: ...
...
class LocalDataTrackIsPublishedResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["is_published", b"is_published"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["is_published", b"is_published"]) -> None: ...
...
class OwnedRemoteDataTrack(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["handle", b"handle", "info", b"info", "publisher_identity", b"publisher_identity"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["handle", b"handle", "info", b"info", "publisher_identity", b"publisher_identity"]) -> None: ...
...
class DataTrackSubscribeOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["buffer_size", b"buffer_size"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["buffer_size", b"buffer_size"]) -> None: ...
...
class RemoteDataTrackPipelineOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["max_partial_frames", b"max_partial_frames"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["max_partial_frames", b"max_partial_frames"]) -> None: ...
...
class RemoteDataTrackSetPipelineOptionsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["options", b"options", "track_handle", b"track_handle"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["options", b"options", "track_handle", b"track_handle"]) -> None: ...
...
class DataTrackStreamReadRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["stream_handle", b"stream_handle"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["stream_handle", b"stream_handle"]) -> None: ...
...
class DataTrackStreamReadResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["eos_event", b"eos_event"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["eos_event", b"eos_event"]) -> None: ...
...
class DataTrackStreamEvent(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["detail", b"detail", "eos", b"eos", "frame_received", b"frame_received", "stream_handle", b"stream_handle"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["detail", b"detail", "eos", b"eos", "frame_received", b"frame_received", "stream_handle", b"stream_handle"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["detail", b"detail"]) -> typing_extensions.Literal["frame_received", "eos"] | None: ...
